...
console.log("Scan gap warning minutes:", env.scanGapWarnMinutes);
console.log("Routine health notifications:", env.healthNotifications);
console.log("Status notification hours:", env.statusNotificationHours);
console.log("Repeated error reminder hours:", env.errorReminderHours);
